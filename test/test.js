...
describe('database - table', function() {
	it('select find by ID', function() {
		var db = new jsondb.Database();
		var t1 = db.get('Table');
		var select1 = t1.findID(0);
		select1.lines.length.should.eql(1);
...
describe('database - table', function() {
	it('modify table add column', function() {
		...
		t1.modify(['Nom', 'Prenom', 'Adresse1', 'Age']);
...
describe('database - table', function() {
	it('modify table remove column', function() {
		...
		t1.columns[1].should.eql('Prenom');
		t1.columns[2].should.eql('Adresse1');
		t1.columns[3].should.eql('Age');
		t1.modify(['Nom', 'Age']);
...
describe('database - table', function() {
	it('update table by ID', function() {
		var db = new jsondb.Database();
		var t1 = db.get('Table');
		t1.lines[1]['Nom'].should.eql('Louis');
		t1.updateID({'Nom': 'Maurice'}, 1);
		t1.lines[1]['Nom'].should.eql('Maurice');
	});
});

describe('database - table', function() {
	it('delete line by ID', function() {
		var db = new jsondb.Database();
		var t1 = db.get('Table');
		t1.lines.length.should.eql(2);		
		t1.deleteID(1, true);
